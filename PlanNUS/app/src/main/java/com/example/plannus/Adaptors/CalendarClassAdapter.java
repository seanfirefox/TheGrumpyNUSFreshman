...
public class CalendarClassAdapter extends FirestoreRecyclerAdapter<NUSClass, CalendarClassAdapter.CalendarHolder> {

    public CalendarClassAdapter(@NonNull FirestoreRecyclerOptions<NUSClass> options) {
        super(options);
    }
    @Override
    protected void onBindViewHolder(@NonNull CalendarClassAdapter.CalendarHolder holder, int position, @NonNull NUSClass model) {
