...
class Test_SAT(unittest.TestCase) :
    ...
    def test_sat_1(self) :
        ...
        scrapper.scrape()
        self.assertEqual(TimeTableSchedulerZ3(scrapper.semesterProcessed, False).optimiseTimetable(), sat)
        print("============================================================")
    ...
    def test_sat_8(self) :
        ...
        scrapper = Scrapper(mods, "2021-2022", 2)
        scrapper.scrape()
        self.assertEqual(TimeTableSchedulerZ3(scrapper.semesterProcessed, True).optimiseTimetable(), sat)
        print("============================================================")
