...
public class SundayTaskFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view =  inflater.inflate(R.layout.fragment_sunday_task, container, false);
        initVars(view);
    ...
    private void initVars(View view) {
        ...
        recyclerView = view.findViewById(R.id.sundayTaskRecyclerVIew);
