...
class Test_UNSAT(unittest.TestCase) :
    ...
    def test_sat_1(self) :
        ...
        scrapper.scrape()
        self.assertEqual(TimeTableSchedulerZ3(scrapper.semesterProcessed, False).optimiseTimetable(), unsat)
        print("============================================================")
    ...
    def test_sat_8(self) :
        ...
        scrapper = Scrapper(mods, "2021-2022", 2)
        scrapper.scrape()
        self.assertEqual(TimeTableSchedulerZ3(scrapper.semesterProcessed, True).optimiseTimetable(), unsat)
        print("============================================================")
